...
class CheckpointEveryNSteps(pl.Callback):
    ...
    def on_batch_end(self, trainer: pl.Trainer, _):
        ...
        if global_step % self.save_step_frequency == 0:
            ...
            # print(f'step: {global_step} save model at {ckpt_path}')
...
def train(args, *more):
    ...
    trainer = Trainer(
                    ...
                    callbacks=[pl.callbacks.EarlyStopping(monitor='val_loss',min_delta=0.00, patience=5,verbose=False, mode='min'), CheckpointEveryNSteps(300)],
                    gpus=args["GPU"],
                    deterministic=True,
                    num_nodes=1,
                    #precision=16,
